...
#'
#' @return A barplot of the confidence interval using the bootstrap method
#' @export
#'
#'
#' @examples myboot2(iter=10000,x=c(1,2,3,4), fun="mean", alpha=1-.95,cx=1)
